...
public class LiveBroadcastService {
     ...
     *
     * <p>🔴 <b>상한은 그 시험의 판정을 움직이지 않는다 — 그래도 여기서 끌어가게 두는 이유가
     * 있다.</b> 계획의 <b>모양</b>(Index Scan · {@code Sort} 없음)은 상한 20~100,000에서
     * <b>안 갈렸다</b>(2026-08-31 Testcontainers PostgreSQL 17, 감사 2회가 별도 postgres에서
     * 재확인). 갈리던 것은 <b>버퍼 수</b>였는데({@code live} 10만 줄에서 20이면 42 · 501이면
     * 407 · 5,000이면 475 · 100,000이면 1,907) <b>그 단언은 이제 없다</b> — 같은 계획인데
     * 힙 배치만으로 50배 갈리는 값이라 거짓 경보를 냈다(감사 2회 중간 1).
     * <b>남는 이유는 「운영과 같은 질의를 잰다」가 그 시험의 전제라서다.</b> 🔴 <b>계획이
     * 갈리는 상한을 못 찾은 것이지 「없다」고 잰 것이 아니다.</b>
     */

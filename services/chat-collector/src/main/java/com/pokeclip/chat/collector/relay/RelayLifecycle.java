 ...
 * 부르는 곳은 {@code CollectorRunner.closeSinks} 하나다. 꺼져 있으면 {@link #NONE}.
 */
public interface RelayLifecycle {
    ...
    /** 판정 줄이 닫은 뒤 읽는 셈. 러너가 인자 하나로 닫기와 셈을 같이 받게 한다({@code ChatArchive.counters()}와 같다). */
    ...
    RelayLifecycle NONE = new RelayLifecycle() {
        ...
        @Override public RelayCounters counters() { return RelayCounters.NONE; }
    };
}

...
public class CollectorHealth implements HealthIndicator {
    ...
    public Health health() {
        ...
        Health.Builder builder = letters.healthy() && !legacyDown(now.state())
        ...
        return builder
                ...
                .withDetail("letterIntake", letterIntake(letters))
     ...
     */
    private static String letterIntake(IntakeStatus.Snapshot letters) {
        if (!letters.enabled()) {
            return "disabled";
        }

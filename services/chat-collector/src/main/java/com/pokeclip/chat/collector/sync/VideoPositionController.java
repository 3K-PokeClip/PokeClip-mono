...
public class VideoPositionController {
     ...
     *
     * <p><b>다만 쿼리 스트링에서 {@code +}는 공백으로 디코드되므로 {@code %2B}로 인코딩해야
     * 한다</b> — 위 예시를 그대로 치면 서버가 받는 값은 {@code 2026-08-24T09:00:01 09:00}이라
     * <b>400이다</b>(실측 2026-08-24). 규약대로이고 고칠 것이 아니지만, 문서가 이 간극을
     * 안 말하면 사람이 curl로 자연스럽게 치고 창구를 의심한다. README의 창구 절에도 적어 뒀다.
     */

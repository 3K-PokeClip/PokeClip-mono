 ...
 * 창고에 파일이 올라가 있고</b>, 「다음 업로드가 그 자리를 덮어쓴다」는 회수 장치가 탈퇴자에게는
 * 영영 안 돈다. 그래서 {@code ProfilePhotoService}가 <b>거절을 받으면 그 파일을 도로 지운다</b>
 * (PR #149 codex P1). <b>새 자리를 더하는 사람은 「거절 뒤에 밖에 남는 것이 있나」를 따로 묻는다</b> —
 * 표만 보면 안 보인다.
 *

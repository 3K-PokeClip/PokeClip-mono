...
public class WithdrawalController {
     ...
     *
     * <p>🔴 <b>이 모양(던져서 401)인 자리는 명부의 일부일 뿐이다</b> — 감싼 자리 중 하나는
     * {@code WithdrawnAccountFilter}인데 그쪽은 던지지 않고 {@code null}을 돌려 통과시킨다(필터라서 반대다).
     * <b>여기에 개수를 적지 않는다</b> — 숫자는 명부 한 줄에만 둔다.

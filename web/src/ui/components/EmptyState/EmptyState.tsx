...
// 있던 것을 승격했다(ConfirmDialog 선례). 올릴 때 셋째로 꼽은 라이브 오프라인(POK-227)은 그 뒤 시안이
// 마스코트 골격(1b · 1g-2)으로 바뀌어 이 카드를 쓰지 않는다(LiveOfflineScreen). 두 사용처의 차이가
// 아이콘과 문자열뿐이라 프롭도 그것만 받는다 — 카드 안 액션이 필요한 시안이 생기면 그때 슬롯을 연다.
//
